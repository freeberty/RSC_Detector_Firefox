document.addEventListener('DOMContentLoaded', () => {
    ...
    browser.tabs.query({active: true, currentWindow: true}).then((tabs) => {
        ...
        // --- Initialize: Passive Scan ---
        browser.tabs.sendMessage(tabId, {action: "get_passive"}).then((res) => {
            if(res.isRSC) {
        ...
        el.btnFinger.addEventListener('click', () => {
            ...
            browser.tabs.sendMessage(tabId, {action: "run_fingerprint"}).then((res) => {
        ...
        el.btnExploit.addEventListener('click', () => {
            ...
            browser.tabs.sendMessage(tabId, {action: "run_exploit", cmd: cmd}).then((res) => {
                ...
                if(res && res.success) {
                    ...
                    browser.runtime.sendMessage({ action: "update_badge" });
                } else {
